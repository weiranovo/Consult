...
// import { getConsultFlagText, getIllnessTimeText } from '@/utils/constants'
import { onMounted, ref } from 'vue'
import { useRoute, useRouter } from 'vue-router'
import consultMore from "./components/consultMore.vue";
import { useCancelOrder, useDeleteOrder } from '@/hooks'
...
<template>
    <div class="consult-detail-page" v-if="item">
        ...
        <cpPaySheet v-model:show="show" :order-id="item.id" :actualPayment="item.actualPayment" />
    </div>
