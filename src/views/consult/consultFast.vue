...
<template>
  <div class="consult-fast-page">
    ...
    <div class="fast-type">
      <router-link to="/consult/dep" class="item" @click="store.commit('consult/setIllnessType',1)">
      ...
      <router-link to="/consult/dep" class="item" @click="store.commit('consult/setIllnessType',0)">
